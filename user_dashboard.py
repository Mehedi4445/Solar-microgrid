...
-----------------------
User-facing dashboard: enter live grid parameters and get AI distribution decisions.
"""
...
from predict import predict, model_loaded, ACTION_COLORS
...
def render():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.markdown("Enter live system parameters below and click **Predict** to receive an AI power distribution decision.")
        st.markdown("---")
    ...
    if submitted:
        ...
        fig_prob = px.bar(
            prob_df, x="Probability (%)", y="Action",
            orientation="h",
            color="Probability (%)",
